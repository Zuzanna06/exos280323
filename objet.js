...
// // fetch(
// //   `https://api.themoviedb.org/3/search/movie?api_key=${ApiKey}&query=code`
// // ).then((response) => console.log(response.json()[0].results));
...
//   await fetchMovie();
//   section.innerHTML = movies.results
//     .map(
//       (film) => `
//     <h2>Le non du film ${film.original_title} ! </h2>
//     <img src="https://image.tmdb.org/t/p/w200${film.poster_path}" alt="">
//     <p> vote average est ${film.vote_average}/10 ${
//         film.vote_average >= 5
//           ? 'Le film est bon <i class="fa-solid fa-thumbs-up"></i>'
//           : 'Le fil est nul <i class="fa-solid fa-thumbs-down"></i>'
//       } </p>
...
// si le film a une note qui  est super ou egal a 5   -> le film est bon
// sinon -> le film est nul
...
// `
//   )
//   .join(""); // innerHTML remplace tout le contenue de la section 1
//section.innerHTML = calcule;
//section.innerHTML = `<p>le moité de mon age est: ${calcule} ans </p>`;
...
//       : console.log("Le fil est nul")
//   )
// );

// results.map((film) => (
//     console.log(film.original_title),
//     (film.vote_average >= 5)?console.log('Le film est bon'):console.log('Le fil est nul')
// ));
